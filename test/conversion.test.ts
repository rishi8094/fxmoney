...
describe('check to see correct conversions are returned', () => {
  it('returns the correct conversion against the base', () => {
    ...
    expect(fxmoney.convert(5, {from: "GBP", to: "USD"})).toStrictEqual({"amount": "6.90", "intAmount": 690, "rawAmount": 6.8999999999999995, "from": "GBP", "to": "USD"});
  });
  ...
  it('returns the correct conversion for base against the base', () => {
    ...
    expect(fxmoney.convert(5, {from: "GBP", to: "GBP"})).toStrictEqual({"amount": "5.00", "intAmount": 500, "rawAmount": 5.0, "from": "GBP", "to": "GBP"});
  });
  ...
  it('returns the correct conversion against non base', () => {
    ...
    expect(fxmoney.convert(7, {from: "USD", to: "EUR"})).toStrictEqual({"amount": "5.88", "intAmount": 588, "rawAmount": 5.884057971014493, "from": "USD", "to": "EUR"});
  });
